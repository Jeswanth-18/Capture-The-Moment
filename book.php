...
<body>
 ...
 <div class="heading" style="background:url(images/header7.jpg) no-repeat">
    <h1>book now</h1>
 </div>
    ...
    <form action="book_form.php" method="post" class="book-form">
       ...
       <div class="flex">
          ...
          <div class="inputBox">
             ...
             <input type="text" placeholder="Type of event" name="event_type">
          </div>
          <div class="inputBox">
             <span>how many days :</span>
             <input type="number" placeholder="number of days" name="no_of_days">
          </div>
          <div class="inputBox">
